...
class PoolDetail(object):
    ...
    def __init__(self, asset=None, asset_depth=None, asset_price=None, asset_price_usd=None, liquidity_units=None, pool_apy=None, rune_depth=None, status=None, synth_supply=None, synth_units=None, units=None, volume24h=None):  # noqa: E501
