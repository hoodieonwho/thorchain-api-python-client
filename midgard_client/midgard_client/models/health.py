...
class Health(object):
    ...
    def __init__(self, database=None, in_sync=None, last_aggregated=None, last_committed=None, last_fetched=None, last_queried=None, scanner_height=None):  # noqa: E501
    ...
    @property
    def last_queried(self):
        """Gets the last_queried of this Health.  # noqa: E501


        :return: The last_queried of this Health.  # noqa: E501
        :rtype: HeightTS
        """
        return self._last_queried

    @last_queried.setter
    def last_queried(self, last_queried):
        """Sets the last_queried of this Health.


        :param last_queried: The last_queried of this Health.  # noqa: E501
        :type: HeightTS
        """
        if last_queried is None:
            raise ValueError("Invalid value for `last_queried`, must not be `None`")  # noqa: E501
